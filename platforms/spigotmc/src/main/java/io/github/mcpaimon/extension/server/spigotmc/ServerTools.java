package io.github.mcpaimon.extension.server.spigotmc;
...
/**
 * The ServerTools extension class for the MCAgents system on SpigotMC.
...
public class ServerTools implements IMCExtension {
    ...
    public void onLoad(Object plugin, Executor executor) {
        if (plugin instanceof MCAgentsPlugin mcagentsPlugin) {
            ...
            mcagentsPlugin.getLogger().info("ServerTools extension loaded successfully on SpigotMC. Tools registered.");
    ...
    public void onDisable(Object plugin, Executor executor) {
        if (plugin instanceof JavaPlugin javaPlugin) {
            javaPlugin.getLogger().info("ServerTools extension has been disabled on SpigotMC.");
        }
    }
}
